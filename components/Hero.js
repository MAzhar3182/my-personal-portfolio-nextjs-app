...
const counterData = [
  ...
  { id: 2, text: "Project Complete", value: "12", valueType: "plus" },
        ...
        <div className="row align-items-center">
          <div className="col-lg-4 col-sm-7">
            <div className="hero-content rmb-55 wow fadeInUp delay-0-2s">
              ...
              <h1>
                <b>Muhammad Azhar</b> Full Stack Developer
              </h1>
              <p>
                I specialize in building modern web applications using the MERN stack
                (MongoDB, Express.js, React, and Node.js). With a passion for crafting
                scalable, high-performance solutions, I turn ideas into seamless digital
                experiences.
              </p>
              <div className="hero-btns">
                ...
                <Link legacyBehavior href="assets/images/hero/myResume.pdf" target="_blank">
